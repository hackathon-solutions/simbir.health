...
public class CreateDoctorTimetableRequestValidation implements Validation {

    @Override
    public void validate(Object o) throws ValidationException {
        if (o instanceof CreateDoctorTimetableRequest request) {
            validate(request);
        }
    }

    private void validate(CreateDoctorTimetableRequest request) throws ValidationException {
